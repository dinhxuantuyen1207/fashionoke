...
<head>
    ...
    <title>Báo Cáo Thống Kê Theo Tháng - Fundo Fashion</title>
                ...
                <div class="page-content">
                    ...
                    <div class="card">
                        <div class="row mt-3 ms-3">
                            ...
                            <div class="col-md-2">
                                <a href="/admin/thong-ke/index">Thống kê theo sản phẩm</a>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($hoa_don as $key => $value)
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                @php
                                                    $timestamp = strtotime($value->thang_nam . '-01');
                                                    $month = date('m', $timestamp);
                                                    $year = date('Y', $timestamp);
                                                    $date_str_vn = "Tháng $month Năm $year";
                                                @endphp
                                                <td>{{ $date_str_vn}}</td>
                                                <td>
                                                ...
                                                <td>
                                                    <a href="/admin/thong-ke/thong-ke-thang/{{$year.'-'.$month}}" class="update-danh-muc"
                                                            >Chi Tiết</a>
                                                </td>
                                            </tr>
                                        @endforeach
